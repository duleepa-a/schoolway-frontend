...
const SignUpForm = () => {
  ...
  return (
    ...
    <div className="flex w-3/4  bg-primary h-4/5 justify-between rounded-br-2xl rounded-tr-2xl">
      ...
      <div className="overflow-hidden justify-items-center pl-20 pt-4">
        <Image
      ...
      <div className="w-full lg:w-2/3 flex items-center justify-center h-min">
        <div className="w-full ">
          ...
          <div className="lg:hidden text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">SchoolWay</h1>
            <div className="w-12 h-1 bg-orange-500 mx-auto rounded-full"></div>
          </div>

          <div className="bg-white rounded-2xl shadow-xl p-18">
            ...
            <form onSubmit={handleSubmit} className="ml-5">
              ...
              <button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold px-2 py-1.5 rounded-lg transition-colors duration-200 transform hover:scale-105"
              >
                sign up
              </button>
            </form>
            ...
            <div className="flex space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center px-2 py-1.5 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 "
              >
              ...
              >
                ...
                <span className="text-gray-700 font-medium text-sm">Sign up with Facebook</span>
              </button>
            </div>
          </div>
        </div>
