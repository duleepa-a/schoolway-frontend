        ...
        <section className="bg-[#F5F7FA] py-12">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <h4 className="text-3xl font-semibold text-yellow-400 mb-3">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="flex items-center gap-3">
                <Users className="w-10 h-10 mr-3 text-yellow-400" />
                <div>
              ...
              <div className="flex items-center gap-3">
                <User className="w-10 h-10 mr-3 text-yellow-400" />
                <div>
              ...
              <div className="flex items-center gap-3">
                <Bus className="w-10 h-10 mr-3 text-yellow-400" />
                <div>
              ...
              <div className="flex items-center gap-3">
                <School className="w-10 h-10 mr-3 text-yellow-400" />
                <div>
